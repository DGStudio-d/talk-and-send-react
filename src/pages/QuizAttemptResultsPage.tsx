...
import { useQuizAttemptResults } from "@/services";

const QuizAttemptResultsPage = () => {
  ...
  const { data, isLoading, error } = useQuizAttemptResults(id);
            ...
            <div className="flex gap-2">
              ...
              {Number.isFinite(id) && (
                <Button
                  variant="outline"
                  onClick={() =>
                    navigate(linkTo(`/quiz/${attempt?.quiz_id ?? ""}`))
                  }
                >
