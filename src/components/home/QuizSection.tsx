...
export const QuizSection: React.FC = () => {
  ...
  // API hooks
  const { data: featuredQuizzes = [], loading: featuredLoading, error: featuredError } = useFeaturedQuizzes(3);
  const { data: languages = [], loading: languagesLoading } = useActiveLanguages();

  // Mock stats for now - these could be fetched from API later
  const stats = [
    { label: t('quiz.stats.totalQuizzes'), value: '150+', icon: BookOpen },
    { label: t('quiz.stats.languages'), value: formatNumber(languages.length), icon: Languages },
    { label: t('quiz.stats.students'), value: '2.8K+', icon: Users },
    { label: t('quiz.stats.successRate'), value: '85%', icon: Target },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold mb-4">{t('quiz.featuredTitle')}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredLoading ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <h4 className="text-xl font-semibold mb-2">{t('quizList.noQuizzes')}</h4>
